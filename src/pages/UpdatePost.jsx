...
const UpdatePost = ()=>{
    ...
    useEffect(()=>{
        const fetchSingleBlog = async()=>{
            const res = await fetch("https://shashikant-blog-api2.onrender.com/api/blog/"+id,{
                method:"GET",
                headers:{
    ...
    const handleSubmit = async()=>{
        console.log(blog);
        const res = await fetch("https://shashikant-blog-api2.onrender.com/api/blog/update/"+id,{
            method:"PUT",
            headers:{
